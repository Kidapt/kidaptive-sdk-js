(function(root, factory) {
    ...
    "use strict";
    var kidaptive_irt, jquery, kidaptive_error, kidaptive_utils, kidaptive_attempt_processor, kidaptive_constants, kidaptive_event_manager, kidaptive_http_client, kidaptive_learner_manager, kidaptive_model_manager, kidaptive_recommendation_manager, kidaptive_trial_manager, kidaptive_user_manager, kidaptive_sdk;
    kidaptive_irt = function() {
        var KidaptiveIrt = {
            estimate: function(y, beta, theta, sigma) {
                return estimate(y || 0, beta || 0, 0, theta || 0, sigma || 0, 0, 0);
            }
        };
    ...
    kidaptive_http_client = function(sjcl, KidaptiveConstants, KidaptiveUtils) {
    ...
    }(sjcl, kidaptive_constants, kidaptive_utils);
    ...
    kidaptive_model_manager = function(KidaptiveConstants, KidaptiveUtils) {
        ...
        KidaptiveModelManager.prototype.refreshLatentAbilities = function(learnerId) {
            if (!learnerId) {
                ...
                return this.sdk.httpClient.ajaxLocal("GET", KidaptiveConstants.ENDPOINTS.ABILITY, {
                    learnerId: learnerId
        ...
        KidaptiveModelManager.prototype.refreshLocalAbilities = function(learnerId) {
            if (!learnerId) {
                ...
                return this.sdk.httpClient.ajaxLocal("GET", KidaptiveConstants.ENDPOINTS.LOCAL_ABILITY, {
                    learnerId: learnerId
                }).then(function(abilities) {
