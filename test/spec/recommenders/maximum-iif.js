...
import KidaptiveSdkMaximumItemInformationRecommender from '../../../src/recommenders/maximum-iif';
import Utils from '../../../src/utils';
import Should from 'should';

export default () => {

  describe('maximumInformationRecommender', () => {

    const recommender = new KidaptiveSdkMaximumItemInformationRecommender(KidaptiveSdk);
    const dimensions = [
    ...
    const items = [
      ...
      {id: 12, uri: 'item/12', localDimension: localDimensions[0], prompt: prompts[9], mean: 5},
      {id: 13, uri: 'item/13', localDimension: localDimensions[0], prompt: prompts[10], mean: 7}
    ]
    ...
    it('localDimensionUri determines what prompts to use', () => {
      ...
      TestUtils.setState({
        [abilityStateKey]: [{dimension: dimensions[0], mean: 6.63, standardDeviation: 1, timestamp: 0}]
      });
  ...
  }); //END maximumInformationRecommender
